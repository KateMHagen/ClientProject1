...
- Create Angular project with ng: `ng new clientproject1.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`clientproject1.client.esproj`).
